    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50 w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between gap-3 md:gap-6">
        ...
        <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
          ...
          <button className="hidden md:flex flex-col items-center text-gray-500 hover:text-blue-600 transition group">
            <span className="text-lg mb-1 text-gray-400 group-hover:text-blue-600">💬</span>
            <span className="text-xs font-normal">Message</span>
          </button>

          {user?.isAdmin && (
            <Link to="/admin" className="hidden md:flex flex-col items-center text-gray-500 hover:text-blue-600 transition group">
