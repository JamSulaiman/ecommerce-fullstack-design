...
// Same catalog used by the frontend (frontend/src/data/products.js -> PRODUCTS)
// so the UI shows real, consistent data once it switches from the static
// import to the live /api/products endpoint.
const products = [
  ...
  { name: 'GoPro HERO6 4K Action Camera - Black', price: 998.0, oldPrice: null, image: '/products/tech/3.jpg', description: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit', category: 'Electronics', stock: 18, rating: 4, ratingNum: 7.5, orders: 154 },
  { name: 'GoPro HERO6 4K Action Camera - Black', price: 998.0, oldPrice: null, image: '/products/tech/2.jpg', description: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit', category: 'Electronics', stock: 18, rating: 4, ratingNum: 7.5, orders: 154 },
  { name: 'GoPro HERO6 4K Action Camera - Black', price: 998.0, oldPrice: null, image: '/products/tech/7.jpg', description: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit', category: 'Electronics', stock: 18, rating: 4, ratingNum: 7.5, orders: 154 },
  { name: 'GoPro HERO6 4K Action Camera - Black', price: 998.0, oldPrice: 1128.0, image: '/products/tech/8.jpg', description: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit', category: 'Electronics', stock: 18, rating: 4, ratingNum: 7.5, orders: 154 },
  { name: 'GoPro HERO6 4K Action Camera - Black', price: 998.0, oldPrice: null, image: '/products/tech/9.jpg', description: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit', category: 'Electronics', stock: 18, rating: 4, ratingNum: 7.5, orders: 154 },
...
const importData = async () => {
  try {
    ...
    if (!adminExists) {
      ...
      console.log('✅ Default admin user created: admin@test.com / 123456');
    } else {
      console.log('ℹ️ Default admin user already exists');
    }

    console.log(`✅ ${products.length} catalog products imported successfully!`);
    process.exit();
  } catch (error) {
